...
if fun_num == 2:
	files = {
		2: 'results/gd_bt_3_abs_fun_num_3.txt',
		3: 'results/gd_bt_global_3_abs_fun_num_3.txt',
		4: 'results/ibgm_3_abs_fun_num_3.txt',
	}
...
# opt_vals = np.array([2, 3, 4, 6, 7, 8])

opt_vals_lyapunov = np.array([3])
